...
워크플로의 **①~④ 단계**를 수행한다 (구두 설명 → 브랜치 분기 질의 → request.md → work.md 작성까지).

## 단계

```
① 사람 → 기능을 구두로 설명
①.5 Claude → "이 기능을 위한 새 작업 브랜치를 만들까요?" 사용자에게 질의
...
기능 생성 요청을 받으면 request.md 작성 **직전** 에 사용자에게 다음을 질의한다:
